...
const verticalLevels: readonly LevelDefinition[] = [
  {
    ...
    difficulty: 'medium',
    launcher: { speed: 2.0, moveRangePercent: 0.38 },
    target: { size: 0.75, speed: 0.85, movementAxis: 'vertical', movementBehavior: 'bounce', moveRangePercent: 0 },
    ball: { speed: 1.3 },
    objective: { requiredHits: 8, requiredPerfectHits: 2, maxMissAllowed: 4, maxShots: 12 },
  ...
  },
  {
    ...
    difficulty: 'medium',
    launcher: { speed: 2.1, moveRangePercent: 0.40 },
    target: { size: 0.70, speed: 1.05, movementAxis: 'vertical', movementBehavior: 'bounce', moveRangePercent: 0 },
    ball: { speed: 1.32 },
    objective: { requiredHits: 9, requiredPerfectHits: 2, maxMissAllowed: 3, maxShots: 13 },
    stars: { oneStarScore: 900, twoStarScore: 1120, threeStarScore: 1340 },
  },
  {
    id: 'level-73',
    order: 73,
    title: 'Vertical Flow',
    difficulty: 'medium',
    launcher: { speed: 2.2, moveRangePercent: 0.42 },
    target: { size: 0.65, speed: 1.25, movementAxis: 'vertical', movementBehavior: 'bounce', moveRangePercent: 0 },
    ball: { speed: 1.34 },
    objective: { requiredHits: 10, requiredPerfectHits: 3, maxMissAllowed: 3, maxShots: 14 },
    stars: { oneStarScore: 1000, twoStarScore: 1240, threeStarScore: 1480 },
    obstacles: [
  ...
  },
  {
    ...
    difficulty: 'hard',
    launcher: { speed: 2.35, moveRangePercent: 0.44 },
    target: { size: 0.58, speed: 1.5, movementAxis: 'vertical', movementBehavior: 'bounce', moveRangePercent: 0 },
    ball: { speed: 1.36 },
    objective: { requiredHits: 11, requiredPerfectHits: 4, maxMissAllowed: 2, maxShots: 14 },
    stars: { oneStarScore: 1100, twoStarScore: 1360, threeStarScore: 1620 },
    obstacles: [
      { id: 'obs-74-a', type: 'movingBlocker', xPercent: 0.5, yPercent: 0.56, widthPercent: 0.13, heightPercent: 0.038, movementAxis: 'horizontal', movementBehavior: 'bounce', speed: 0.1, moveRangePercent: 0.2 },
    ],
  },
  {
    id: 'level-75',
    ...
    difficulty: 'hard',
    launcher: { speed: 2.5, moveRangePercent: 0.46 },
    target: { size: 0.52, speed: 1.75, movementAxis: 'vertical', movementBehavior: 'bounce', moveRangePercent: 0 },
    ball: { speed: 1.38 },
    objective: { requiredHits: 12, requiredPerfectHits: 4, maxMissAllowed: 2, maxShots: 15 },
    stars: { oneStarScore: 1200, twoStarScore: 1480, threeStarScore: 1760 },
    obstacles: [
      { id: 'obs-75-a', type: 'movingBlocker', xPercent: 0.35, yPercent: 0.54, widthPercent: 0.11, heightPercent: 0.036, movementAxis: 'horizontal', movementBehavior: 'bounce', speed: 0.12, moveRangePercent: 0.16 },
      { id: 'obs-75-b', type: 'movingBlocker', xPercent: 0.65, yPercent: 0.54, widthPercent: 0.11, heightPercent: 0.036, movementAxis: 'horizontal', movementBehavior: 'bounce', speed: 0.12, moveRangePercent: 0.16 },
    ],
  },
  {
    id: 'level-76',
    ...
    difficulty: 'hard',
    levelType: 'boss',
    launcher: { speed: 2.8, moveRangePercent: 0.50 },
    target: { size: 0.40, speed: 2.1, movementAxis: 'vertical', movementBehavior: 'bounce', moveRangePercent: 0 },
    ball: { speed: 1.42 },
    objective: { requiredHits: 8, requiredPerfectHits: 5, maxMissAllowed: 1, maxShots: 12 },
    stars: { oneStarScore: 1380, twoStarScore: 1680, threeStarScore: 1960 },
    obstacles: [
      { id: 'obs-76-a', type: 'movingBlocker', xPercent: 0.5, yPercent: 0.55, widthPercent: 0.14, heightPercent: 0.04, movementAxis: 'horizontal', movementBehavior: 'bounce', speed: 0.16, moveRangePercent: 0.22 },
    ],
  },
];
...
const blinkLevels: readonly LevelDefinition[] = [
  {
    ...
    title: 'Blink Primer',
    difficulty: 'medium',
    launcher: { speed: 2.05, moveRangePercent: 0.36 },
    target: { size: 0.72, speed: 1.1, movementAxis: 'horizontal', movementBehavior: 'bounce', moveRangePercent: 0.28, blink: { visibleMs: 1800, hiddenMs: 400 } },
    ball: { speed: 1.30 },
    objective: { requiredHits: 7, requiredPerfectHits: 2, maxMissAllowed: 4, maxShots: 12 },
    stars: { oneStarScore: 820, twoStarScore: 1040, threeStarScore: 1240 },
  },
  {
    id: 'level-78',
    order: 78,
    ...
    target: { size: 0.68, speed: 1.2, movementAxis: 'horizontal', movementBehavior: 'bounce', moveRangePercent: 0.32, blink: { visibleMs: 1400, hiddenMs: 500 } },
    ball: { speed: 1.32 },
    objective: { requiredHits: 8, requiredPerfectHits: 2, maxMissAllowed: 3, maxShots: 13 },
    stars: { oneStarScore: 920, twoStarScore: 1160, threeStarScore: 1380 },
  },
  {
    id: 'level-79',
    order: 79,
    title: 'Blink Flow',
    difficulty: 'hard',
    launcher: { speed: 2.3, moveRangePercent: 0.42 },
    target: { size: 0.62, speed: 1.4, movementAxis: 'horizontal', movementBehavior: 'loop', moveRangePercent: 0.36, blink: { visibleMs: 1100, hiddenMs: 600 } },
    ball: { speed: 1.34 },
    objective: { requiredHits: 9, requiredPerfectHits: 3, maxMissAllowed: 2, maxShots: 13 },
    stars: { oneStarScore: 1040, twoStarScore: 1300, threeStarScore: 1540 },
    obstacles: [
      { id: 'obs-79-a', type: 'blocker', xPercent: 0.5, yPercent: 0.54, widthPercent: 0.1, heightPercent: 0.034 },
    ],
  },
  {
    id: 'level-80',
    ...
    title: 'Blink Focus',
    difficulty: 'hard',
    launcher: { speed: 2.45, moveRangePercent: 0.46 },
    target: { size: 0.55, speed: 1.65, movementAxis: 'horizontal', movementBehavior: 'bounce', moveRangePercent: 0.40, blink: { visibleMs: 900, hiddenMs: 700 } },
    ball: { speed: 1.36 },
    objective: { requiredHits: 10, requiredPerfectHits: 4, maxMissAllowed: 2, maxShots: 14 },
    stars: { oneStarScore: 1160, twoStarScore: 1440, threeStarScore: 1700 },
    obstacles: [
      { id: 'obs-80-a', type: 'movingBlocker', xPercent: 0.5, yPercent: 0.56, widthPercent: 0.12, heightPercent: 0.036, movementAxis: 'horizontal', movementBehavior: 'bounce', speed: 0.13, moveRangePercent: 0.18 },
    ],
  },
  {
    id: 'level-81',
    ...
    title: 'Blink Final',
    difficulty: 'hard',
    launcher: { speed: 2.6, moveRangePercent: 0.50 },
    target: { size: 0.48, speed: 1.9, movementAxis: 'horizontal', movementBehavior: 'loop', moveRangePercent: 0.44, blink: { visibleMs: 700, hiddenMs: 800 } },
    ball: { speed: 1.38 },
    objective: { requiredHits: 11, requiredPerfectHits: 5, maxMissAllowed: 1, maxShots: 14 },
    stars: { oneStarScore: 1280, twoStarScore: 1580, threeStarScore: 1860 },
    obstacles: [
      { id: 'obs-81-a', type: 'movingBlocker', xPercent: 0.36, yPercent: 0.54, widthPercent: 0.1, heightPercent: 0.034, movementAxis: 'horizontal', movementBehavior: 'bounce', speed: 0.14, moveRangePercent: 0.16 },
      { id: 'obs-81-b', type: 'blocker', xPercent: 0.64, yPercent: 0.46, widthPercent: 0.09, heightPercent: 0.032 },
    ],
  },
  {
    id: 'level-82',
    ...
    difficulty: 'hard',
    levelType: 'boss',
    launcher: { speed: 2.9, moveRangePercent: 0.54 },
    target: { size: 0.38, speed: 2.2, movementAxis: 'horizontal', movementBehavior: 'bounce', moveRangePercent: 0.48, blink: { visibleMs: 600, hiddenMs: 900 } },
    ball: { speed: 1.42 },
    objective: { requiredHits: 8, requiredPerfectHits: 6, maxMissAllowed: 1, maxShots: 12 },
    stars: { oneStarScore: 1440, twoStarScore: 1760, threeStarScore: 2060 },
    obstacles: [
      { id: 'obs-82-a', type: 'movingBlocker', xPercent: 0.5, yPercent: 0.55, widthPercent: 0.14, heightPercent: 0.04, movementAxis: 'horizontal', movementBehavior: 'bounce', speed: 0.18, moveRangePercent: 0.24 },
    ],
  },
];
...
const diagonalLevels: readonly LevelDefinition[] = [
  {
    ...
    difficulty: 'hard',
    launcher: { speed: 2.2, moveRangePercent: 0.40 },
    target: { size: 0.68, speed: 0.9, verticalSpeed: 0.7, movementAxis: 'diagonal', movementBehavior: 'bounce', moveRangePercent: 0.24 },
    ball: { speed: 1.32 },
    objective: { requiredHits: 8, requiredPerfectHits: 2, maxMissAllowed: 4, maxShots: 12 },
    stars: { oneStarScore: 900, twoStarScore: 1140, threeStarScore: 1360 },
  },
  {
    id: 'level-84',
    order: 84,
    ...
    difficulty: 'hard',
    launcher: { speed: 2.35, moveRangePercent: 0.44 },
    target: { size: 0.62, speed: 1.1, verticalSpeed: 0.9, movementAxis: 'diagonal', movementBehavior: 'bounce', moveRangePercent: 0.28 },
    ball: { speed: 1.34 },
    objective: { requiredHits: 9, requiredPerfectHits: 3, maxMissAllowed: 3, maxShots: 13 },
    stars: { oneStarScore: 1020, twoStarScore: 1280, threeStarScore: 1520 },
  },
  {
    id: 'level-85',
    order: 85,
    title: 'Diagonal Flow',
    difficulty: 'hard',
    launcher: { speed: 2.5, moveRangePercent: 0.48 },
    target: { size: 0.55, speed: 1.35, verticalSpeed: 1.1, movementAxis: 'diagonal', movementBehavior: 'bounce', moveRangePercent: 0.32 },
    ball: { speed: 1.36 },
    objective: { requiredHits: 10, requiredPerfectHits: 3, maxMissAllowed: 2, maxShots: 14 },
    stars: { oneStarScore: 1140, twoStarScore: 1420, threeStarScore: 1680 },
    obstacles: [
  ...
  },
  {
    ...
    difficulty: 'hard',
    launcher: { speed: 2.65, moveRangePercent: 0.52 },
    target: { size: 0.48, speed: 1.6, verticalSpeed: 1.3, movementAxis: 'diagonal', movementBehavior: 'bounce', moveRangePercent: 0.36 },
    ball: { speed: 1.38 },
    objective: { requiredHits: 11, requiredPerfectHits: 4, maxMissAllowed: 2, maxShots: 15 },
    stars: { oneStarScore: 1260, twoStarScore: 1560, threeStarScore: 1840 },
    obstacles: [
      { id: 'obs-86-a', type: 'blocker', xPercent: 0.3, yPercent: 0.5, widthPercent: 0.1, heightPercent: 0.032 },
      { id: 'obs-86-b', type: 'blocker', xPercent: 0.7, yPercent: 0.5, widthPercent: 0.1, heightPercent: 0.032 },
    ],
  },
  {
    id: 'level-87',
    ...
    difficulty: 'hard',
    launcher: { speed: 2.8, moveRangePercent: 0.56 },
    target: { size: 0.42, speed: 1.9, verticalSpeed: 1.6, movementAxis: 'diagonal', movementBehavior: 'bounce', moveRangePercent: 0.40 },
    ball: { speed: 1.40 },
    objective: { requiredHits: 12, requiredPerfectHits: 5, maxMissAllowed: 1, maxShots: 15 },
    stars: { oneStarScore: 1380, twoStarScore: 1700, threeStarScore: 2000 },
    obstacles: [
      { id: 'obs-87-a', type: 'movingBlocker', xPercent: 0.5, yPercent: 0.55, widthPercent: 0.12, heightPercent: 0.036, movementAxis: 'horizontal', movementBehavior: 'bounce', speed: 0.15, moveRangePercent: 0.20 },
    ],
  },
  {
    id: 'level-88',
    ...
    difficulty: 'hard',
    levelType: 'boss',
    launcher: { speed: 3.1, moveRangePercent: 0.60 },
    target: { size: 0.34, speed: 2.2, verticalSpeed: 1.8, movementAxis: 'diagonal', movementBehavior: 'bounce', moveRangePercent: 0.44, blink: { visibleMs: 700, hiddenMs: 400 } },
    ball: { speed: 1.44 },
    objective: { requiredHits: 8, requiredPerfectHits: 6, maxMissAllowed: 1, maxShots: 12 },
    stars: { oneStarScore: 1560, twoStarScore: 1920, threeStarScore: 2240 },
    obstacles: [
      { id: 'obs-88-a', type: 'movingBlocker', xPercent: 0.5, yPercent: 0.55, widthPercent: 0.14, heightPercent: 0.04, movementAxis: 'horizontal', movementBehavior: 'bounce', speed: 0.18, moveRangePercent: 0.24 },
    ],
  },
];
